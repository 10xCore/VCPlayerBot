...
async def start(client, message):
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton('🧩 Source', url='https://github.com/10xCore/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/10xCore/VCPlayerBot'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/subin_works'),     
        ],
        [

...
![GitHub Repo stars](https://img.shields.io/github/stars/10xCores/VCPlayerBot?color=blue&style=flat)
![GitHub issues](https://img.shields.io/github/issues/10xCore/VCPlayerBot)
![GitHub pull requests](https://img.shields.io/github/issues-pr/10xCore/VCPlayerBot)
![GitHub contributors](https://img.shields.io/github/contributors/10xCore/VCPlayerBot?style=flat)
![GitHub forks](https://img.shields.io/github/forks/10xCore/VCPlayerBot?style=flat)
...
4. `SESSION_STRING` : Generate From here [![GenerateStringName](https://img.shields.io/badge/repl.it-generateStringName-yellowgreen)](https://repl.it/@10xCore/getStringName)
...
## Deploy to Railway
<p><a href=https://github.com/10xCore/VCPlayerBot/issues/7> <img src="https://img.shields.io/badge/Deploy%20To%20Railway-blueviolet?style=for-the-badge&logo=railway" width="200""/></a></p>

 
## Deploy to VPS

```sh
git clone https://github.com/10xCore/VCPlayerBot
cd VCPlayerBot
